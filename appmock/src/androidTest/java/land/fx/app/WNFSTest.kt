 ...
 */       
        ...
        val fileNames_root: ByteArray = ls(client, config.cid, config.private_ref, "root")
        Log.d("AppMock", "ls on root. fileNames_root="+String(fileNames_root))
        ...
        val fileNames_test1: ByteArray = ls(client, config.cid, config.private_ref, "root/test1")
        Log.d("AppMock", "ls on root/test1. fileNames_test1="+String(fileNames_test1))
        //[]
        val fileNames: ByteArray = ls(client, config.cid, config.private_ref, "")
        Log.d("AppMock", "ls on /. fileNames="+String(fileNames))
